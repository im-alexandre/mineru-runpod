...
* add otel ([cf45542](https://github.com/im-alexandre/mineru-runpod/commit/cf45542737f791a572556a537e456afa76e3e9c7))
* add structural logs support ([d864d8a](https://github.com/im-alexandre/mineru-runpod/commit/d864d8a2f0cac7f53aaaf7eaa8b02d753d9b3119))
* add transport + formats fields and unify response shape ([5fd5a8f](https://github.com/im-alexandre/mineru-runpod/commit/5fd5a8f9aac0498d508e57b537b54e087d3121b7))
* add worker warmup ([348b1dc](https://github.com/im-alexandre/mineru-runpod/commit/348b1dc240e63bacbd8890e636f0a20216973270))
* bump mineru to 3.2 ([6e70f45](https://github.com/im-alexandre/mineru-runpod/commit/6e70f4520f583bfb1bdeb40fe024a1205a8bfa21))
* **client:** add MinerU API-compatible client (MineruApiClient) ([62cd9b6](https://github.com/im-alexandre/mineru-runpod/commit/62cd9b6a769bf86ac261584622890137f353f463))
* **docs:** add Choosing a GPU guide ([3aa6506](https://github.com/im-alexandre/mineru-runpod/commit/3aa650650fa91a79472b25f76e027428a7b93752))
* **docs:** scaffold Astro + Starlight site with launch blog post ([aaeaa27](https://github.com/im-alexandre/mineru-runpod/commit/aaeaa27eed2912928fc068b44b7709842714a482))
* prepare runpod-mineru for public RunPod Hub launch ([9690fe9](https://github.com/im-alexandre/mineru-runpod/commit/9690fe9956665dfe0d53cec494c541c1ce5a398e))
* **worker:** add archive_format (tar.gz/zip) for archive transports ([e90d079](https://github.com/im-alexandre/mineru-runpod/commit/e90d0790abfb73d1f291dc7a96a5b601ce2de68c))
* **worker:** normalize the job input surface and add endpoint-level limits ([#19](https://github.com/im-alexandre/mineru-runpod/issues/19)) ([4bd9219](https://github.com/im-alexandre/mineru-runpod/commit/4bd92198f561249ad82059ae94636a032ba8bc62))
* **worker:** upgrade MinerU to 3.4 and add effort control ([#10](https://github.com/im-alexandre/mineru-runpod/issues/10)) ([af44cc6](https://github.com/im-alexandre/mineru-runpod/commit/af44cc6bfc3d05b066a2c1b518fb7f12fdfd5a5c))

### Bug Fixes

* add higher cuda versions ([4514d55](https://github.com/im-alexandre/mineru-runpod/commit/4514d554f1cd02831b3dc3f74fed03d517f9f153))
* add icon to hub.json ([40d5ff8](https://github.com/im-alexandre/mineru-runpod/commit/40d5ff8faab9ecf3c37c8642a2a2dbffe045f912))
* add logger debug ([b57c47f](https://github.com/im-alexandre/mineru-runpod/commit/b57c47f1578cb6a0f9cd00b40a30195891055f65))
* add otel pacakges for tests ([4756f92](https://github.com/im-alexandre/mineru-runpod/commit/4756f922cb9b64f8dfcc0830bd65cdeb121fa7b4))
* add symlink to handler.py ([bf9be39](https://github.com/im-alexandre/mineru-runpod/commit/bf9be3913caad5a62f8decc93fca05bc01d373bb))
* bump cuda ([2e4411e](https://github.com/im-alexandre/mineru-runpod/commit/2e4411e1562d804ad7798fe163d3db672f7263db))
* bump runpod ci ([bc0d2cd](https://github.com/im-alexandre/mineru-runpod/commit/bc0d2cd48bec0bdca7591f1a1f29853015129f17))
* **client:** omit None end_page from payload; better error message fallback ([52dbc53](https://github.com/im-alexandre/mineru-runpod/commit/52dbc53ec3cf8499f16a157273f12f55477232c0))
* **client:** reject MinerU callback param and add archive download timeouts ([68e7193](https://github.com/im-alexandre/mineru-runpod/commit/68e719314f2df166391f1e0b3e6b9dcee9cda70f))
* **docs:** audit troubleshooting + language claims against empirical evidence ([cc6f064](https://github.com/im-alexandre/mineru-runpod/commit/cc6f0645796953525cc84c343f375c030180b2a6))
* **docs:** correct per-page speed claims and Blackwell wording per empirical + upstream evidence ([e555a7a](https://github.com/im-alexandre/mineru-runpod/commit/e555a7a49844e144c5e03cea75b424494b4e6358))
* drop packaging progress_update that races the final result post ([#9](https://github.com/im-alexandre/mineru-runpod/issues/9)) ([8dd3b38](https://github.com/im-alexandre/mineru-runpod/commit/8dd3b38ec8cf024d36c148f1714fc5aa276fc6e3)), closes [#4](https://github.com/im-alexandre/mineru-runpod/issues/4)
* fixing runpod hub flow ([a8116fd](https://github.com/im-alexandre/mineru-runpod/commit/a8116fdb9585998cedc408fbe752c382bd6bde7a))
* **hub:** add test_input.json + switch pip to uv for faster builds ([561f7e7](https://github.com/im-alexandre/mineru-runpod/commit/561f7e7452c0419909c6faf638c318cef2a5f717))
* **hub:** align manifests with official template schema ([bc3903b](https://github.com/im-alexandre/mineru-runpod/commit/bc3903b1f239f8f6eccc64b1f6a8c631cfe487f9))
* **hub:** bump container disk 30 -> 50 GB to accommodate baked-in models ([f8872aa](https://github.com/im-alexandre/mineru-runpod/commit/f8872aa4f35c68168c5dedd6dff8d14e76e77adc))
* **hub:** correct GPU pool IDs (ADA_48 → ADA_48_PRO) ([844f1be](https://github.com/im-alexandre/mineru-runpod/commit/844f1befcf45bd0a24c10905d429d3aa531e5dc5))
* **hub:** drop ADA_48_PRO from default GPU pools; refresh template metadata ([ac0f5df](https://github.com/im-alexandre/mineru-runpod/commit/ac0f5dfa5dfcbf7b8b3e4af8f54ca340ed8865ed))
* **hub:** expose configurable env vars via hub.json deploy-time form ([9ef4ae4](https://github.com/im-alexandre/mineru-runpod/commit/9ef4ae4c2d0dab5471f2ff657e68c17a02a8ac70))
* **hub:** pre-cache MinerU weights in image; bump test timeout to 20 min ([3bbef3a](https://github.com/im-alexandre/mineru-runpod/commit/3bbef3ad62c2836d1128492fa295ab63014ad56b))
* **hub:** set MINERU_VL_MODEL_NAME so the local vlm backend loads Pro-2604 ([1abd2ba](https://github.com/im-alexandre/mineru-runpod/commit/1abd2ba4eedef5f70f81fd755d806b83ce32e608))
* **hub:** switch test GPU from RTX 4090 to RTX A5000 ([be7a262](https://github.com/im-alexandre/mineru-runpod/commit/be7a26223507ada4cf783904abd0969b09e1a90d))
* **hub:** switch test GPU to A40 ([dbad547](https://github.com/im-alexandre/mineru-runpod/commit/dbad54764d9c15b6b93cb7f3825d4acda2532641))
* **hub:** switch test GPU to A5000 ([2804636](https://github.com/im-alexandre/mineru-runpod/commit/280463691d95317b2a010d1cc38b59d39993a2f2))
* **hub:** use python3 instead of python in Dockerfile ([3b0e778](https://github.com/im-alexandre/mineru-runpod/commit/3b0e778aa1479e8779edd75e1ba660e6542cf321))
* **hub:** widen allowedCudaVersions to ease GPU supply constraints ([cc34711](https://github.com/im-alexandre/mineru-runpod/commit/cc347113f7b4d16a82bccdfe9f5c86e3452c6fad))
* import after refactor ([6803381](https://github.com/im-alexandre/mineru-runpod/commit/680338185c4e5a77cbf5dc3577f9a99d3b98c2f2))
* make file symlink ([a390ad5](https://github.com/im-alexandre/mineru-runpod/commit/a390ad512aadd552fdea0b7f6d7adb9d05ef5a19))
* readme badge update ([a1236f2](https://github.com/im-alexandre/mineru-runpod/commit/a1236f254cc24c8b50abf91ecac616cf8c5440ec))
* refine hub descriptions ([ca93e91](https://github.com/im-alexandre/mineru-runpod/commit/ca93e91753c3807bf9bc535281ba5f86ec76af38))
* remove runpod-disabled folder ([091fd56](https://github.com/im-alexandre/mineru-runpod/commit/091fd56ca4516750cdc23e5694b3bc9e466acc4e))
* rename repo to fix hub workflow ([ec98e38](https://github.com/im-alexandre/mineru-runpod/commit/ec98e38744cfeec3102b0313567ebbd530bb3857))
* revert back since don't help to hub release ([e15ba6f](https://github.com/im-alexandre/mineru-runpod/commit/e15ba6f32e1e0c9c4654debd6a65720d06b67fa0))
* revert to print logger because runpod doesn't support structured logs ([3539f86](https://github.com/im-alexandre/mineru-runpod/commit/3539f86394854d9519704a183a817c7553d8d93f))
* shorten hub.json descriptions to stay under varchar 191 ([5a5fe47](https://github.com/im-alexandre/mineru-runpod/commit/5a5fe47aea8afab961c6a711a9dcbeee14be50a2))
* speedup models download with hf xet ([a940a6c](https://github.com/im-alexandre/mineru-runpod/commit/a940a6ce9e726e0f86230616ea36df91377716b4))
* switch to 4090 + warmup test on JobScaler ([8599324](https://github.com/im-alexandre/mineru-runpod/commit/8599324a72fc40426841047637844dfcd6f935f2))
* trying exactly recommended readme badge to fix runpod hub publishing workflow ([1bf1ce5](https://github.com/im-alexandre/mineru-runpod/commit/1bf1ce542f533a2684059b7f884dc097a242d93d))
* trying to add hub.json for hub ([1f38d12](https://github.com/im-alexandre/mineru-runpod/commit/1f38d129653fc1c55e55e8d67fe8b2a588ebc40c))
* trying to fix runpod hub release ([f8c53c9](https://github.com/im-alexandre/mineru-runpod/commit/f8c53c9ee9b111268b9873046c2cfc4b9b22ba18))
* trying to fix runpod hub workflow ([62ca5ec](https://github.com/im-alexandre/mineru-runpod/commit/62ca5ec3c1a5f5dccd3705260d2464bc983ac9d5))
* update docs and readme stale version + revert tests to 4090 ([7939c39](https://github.com/im-alexandre/mineru-runpod/commit/7939c393d6fcfbaee4d1a0c4e539ab7f360c35cb))
* **worker:** add S3 output mode + BUCKET_* env support ([2f2451e](https://github.com/im-alexandre/mineru-runpod/commit/2f2451e60480cb1ae5cc8ec55e6325b0440063c3))
* **worker:** align API with MinerU 3.1.x — parse_document, file_* fields, 5 backends, multi-format input, debug observability ([b763659](https://github.com/im-alexandre/mineru-runpod/commit/b763659b580206749179afc4013d5d9d5fd4a6ee))
* **worker:** bake both MinerU models into image at build time ([fcbff51](https://github.com/im-alexandre/mineru-runpod/commit/fcbff513c76e54901d4f5ff7eee7a006ac1d6768))
* **worker:** bump MinerU to 3.1.x and vLLM base to v0.11.2; switch to RunPod Cached Models ([07efb50](https://github.com/im-alexandre/mineru-runpod/commit/07efb504987484a697bd97b63bf1aa1dbd6434b3))
* **worker:** drain in-flight jobs on SIGTERM instead of failing them ([#12](https://github.com/im-alexandre/mineru-runpod/issues/12)) ([23d8d02](https://github.com/im-alexandre/mineru-runpod/commit/23d8d0218fab36257af9ab2c025ace004376e37e))
* **worker:** override HF_HUB_OFFLINE=0 inline on the model-bake RUN step ([70aa5fe](https://github.com/im-alexandre/mineru-runpod/commit/70aa5fe6a0fde95cb97bfcacc2256a8c5c8f9ddc))
* **worker:** symlink lowercase Cached Models dir to canonical HF case at startup ([da5ebb4](https://github.com/im-alexandre/mineru-runpod/commit/da5ebb488a04e956c4ac16f69b1cb6f2a709ee9b))

### Documentation

* add 'Supported GPU pools' reference table to choosing-gpu ([72b8407](https://github.com/im-alexandre/mineru-runpod/commit/72b84072f5af2de86199ebcb4fddbb90a37ea4ec))
* add blackwell workaround and backlog info ([16244e9](https://github.com/im-alexandre/mineru-runpod/commit/16244e92b67a2fe27febee52f261b5ddec4c9526))
* add blog post ([6950a7c](https://github.com/im-alexandre/mineru-runpod/commit/6950a7c4318e9a76cf3ae9f351180dc5e43bed5b))
* add blog post about flash boot ([b214a38](https://github.com/im-alexandre/mineru-runpod/commit/b214a384a2c9f9a7aea09c124c2be592954ddc6d))
* add Cloudflare Web Analytics beacon to the docs site ([#18](https://github.com/im-alexandre/mineru-runpod/issues/18)) ([357cc36](https://github.com/im-alexandre/mineru-runpod/commit/357cc362a4e8101bf18b11a0557f03221cf267d1))
* add concurrency guide and fix stale GPU sizing guidance ([da938a4](https://github.com/im-alexandre/mineru-runpod/commit/da938a4d306a404a625e9beea6fe4b89d3e60dd5))
* add self-host MinerU API blog post ([0d82d9b](https://github.com/im-alexandre/mineru-runpod/commit/0d82d9b7c3d2b2106707dd1fb8d4eb34b4260daf))
* aggressive em-dash reduction in launch blog post ([f6fc445](https://github.com/im-alexandre/mineru-runpod/commit/f6fc4455ada9a13d2ba81bc3a4a136bb867cd4a2))
* align all documentation with MinerU 3.1.x official recommendations ([bac4137](https://github.com/im-alexandre/mineru-runpod/commit/bac413720d1b27eab939a04725942fd512511d0b))
* align articles with latest info ([b8d2b60](https://github.com/im-alexandre/mineru-runpod/commit/b8d2b60151e616d1969ff1678acea6c60c445240))
* align SEO, API guidance, and OpenTelemetry documentation ([#17](https://github.com/im-alexandre/mineru-runpod/issues/17)) ([314385d](https://github.com/im-alexandre/mineru-runpod/commit/314385d192535abf06756bfcaff406f454ef0e1e))
* apply voice polish per seo-blog skill rules ([ba07ccd](https://github.com/im-alexandre/mineru-runpod/commit/ba07ccd2f43135b1b0a9e05e7238167d2324f4cf))
* **backlog:** re-verify Blackwell blocker against MinerU 3.2.0 ([2bc1365](https://github.com/im-alexandre/mineru-runpod/commit/2bc136510e8589d928e984bc29035e75b009b4e8))
* badge links fix ([f5327c4](https://github.com/im-alexandre/mineru-runpod/commit/f5327c4a957317b723b43b9b4401a021326dd2f0))
* blog post about popular runpod error ([8a25752](https://github.com/im-alexandre/mineru-runpod/commit/8a2575299b160374ae9bb641f4ef7077db41eac7))
* blog post crosslink ([2eb0e0b](https://github.com/im-alexandre/mineru-runpod/commit/2eb0e0b3da1ff3fb10a74a7622248a3ff0e53b14))
* consolidate referral disclosure to a single footer ([fa13e67](https://github.com/im-alexandre/mineru-runpod/commit/fa13e6743602dc042872e71ad9119695f11c0a3d))
* correct cold-start and model-download claims in self-host post ([7cc8b0d](https://github.com/im-alexandre/mineru-runpod/commit/7cc8b0d01d5cbeadd0593083ac47555a0f25eb1b))
* correct facts after independent source revalidation ([d2fed43](https://github.com/im-alexandre/mineru-runpod/commit/d2fed431764d9466ff088cf2df4592f35cf742d0))
* correct Marker license claim with RAIL-M competitor clause ([90a3807](https://github.com/im-alexandre/mineru-runpod/commit/90a3807a1bd0c020e855a5b025a662b000116df9))
* disclosure + ref update ([2637639](https://github.com/im-alexandre/mineru-runpod/commit/26376390698b5e43d13729c5cbf5e28a8d47c6ec))
* drop batch from public docs; document worker-scaling for parallelism ([10ba60e](https://github.com/im-alexandre/mineru-runpod/commit/10ba60e6d1d7fead022ad625039af90d9e0a87b5))
* drop fictional PyPI install lines from README ([9a4d3d6](https://github.com/im-alexandre/mineru-runpod/commit/9a4d3d6557041715a70bf0093d76173d94989bbb))
* example + blog post ([6eb311a](https://github.com/im-alexandre/mineru-runpod/commit/6eb311a6ed7ec5c82d6e7f00bc58f809dca5af93))
* explain that the Hub template builds an image rather than pulling one ([6032696](https://github.com/im-alexandre/mineru-runpod/commit/6032696b34ee56afcb359929d28beea3501d879b))
* fix 404 blog cross-links to use dated slugs ([019c9f5](https://github.com/im-alexandre/mineru-runpod/commit/019c9f53dc96e62a31badfb06f98e7cf9da91b1f))
* fix links in blog posts ([6fdc68e](https://github.com/im-alexandre/mineru-runpod/commit/6fdc68e97d3a650fa1cc279ff8ed17c34dd8fd2c))
* fix reader-perspective inconsistencies across public docs ([b72d1d5](https://github.com/im-alexandre/mineru-runpod/commit/b72d1d5d3d2cbd6dd61d1831e358cec08670a9f4))
* four new guides + README quickstart, schema table, cross-links ([9b8a237](https://github.com/im-alexandre/mineru-runpod/commit/9b8a237bce5bd2f0a9a0da46d66599664d2fdc79))
* migrate site to mineru.shmakov.tools ([#16](https://github.com/im-alexandre/mineru-runpod/issues/16)) ([b22b1cf](https://github.com/im-alexandre/mineru-runpod/commit/b22b1cf733591a485776716c31fc4596e2f82252))
* minor docs update ([1a3eaa6](https://github.com/im-alexandre/mineru-runpod/commit/1a3eaa6bdb28cff1c9c6d4a33f97aa592fab639b))
* minor updates to docs ([db17801](https://github.com/im-alexandre/mineru-runpod/commit/db17801a6783fd12f8bb5ea32d3ce5fa96b96890))
* patch RSS feed with channel base path, author, and atom:link ([7b826ea](https://github.com/im-alexandre/mineru-runpod/commit/7b826ea09b8ad58611d28e8336cf09139b4496ac))
* rename return to transport in network volumes guide ([a65c08c](https://github.com/im-alexandre/mineru-runpod/commit/a65c08cbf8010a76fc90937e57af06b57ec123f4))
* shorten subheader ([7b1e4e6](https://github.com/im-alexandre/mineru-runpod/commit/7b1e4e6cc444587d772715fa1dfdf1f4899d4c7e))
* show debug block in failure response example ([21f5a11](https://github.com/im-alexandre/mineru-runpod/commit/21f5a11ef5990d90a7c77374d145e23e08e9cf12))
* site theme ([f6cbdeb](https://github.com/im-alexandre/mineru-runpod/commit/f6cbdeb9cf2ec4ca2f3fd08ba23ceb99079a3491))
* slim README to a promo page; move details to docs site ([b0c23c0](https://github.com/im-alexandre/mineru-runpod/commit/b0c23c0a4960b00a19acfc44f49703b127ced18b))
* stop wide tables overlapping the sidebar and give the nav a backdrop ([5dabfad](https://github.com/im-alexandre/mineru-runpod/commit/5dabfad85c9f8f7b5234aaf1acd57fcfa4a793fe))
* thin the header veil so the backdrop blur is actually visible ([dfab1e3](https://github.com/im-alexandre/mineru-runpod/commit/dfab1e35bd38997e06d417f7b023ee9acd0836d1))
* tune subheader text ([662aa74](https://github.com/im-alexandre/mineru-runpod/commit/662aa74ee5bebca71cf84ba3ebb72877ee203e9d))
* update docs + blog ([11587f5](https://github.com/im-alexandre/mineru-runpod/commit/11587f5d6b66ee52c4123c94fb0bd18540be7ace))
* update docs about flash boot ([93fe53f](https://github.com/im-alexandre/mineru-runpod/commit/93fe53f96e6397ee60727a0cc738c924eea73028))
* update docs and blog post about observability ([d0a2505](https://github.com/im-alexandre/mineru-runpod/commit/d0a250506ad3340836d0b37dbbae3c724186d15d))
* update docs links ([6a7be0a](https://github.com/im-alexandre/mineru-runpod/commit/6a7be0ad998389e9bb263e395cc435316e56ce58))
* update docs site styles ([75ced01](https://github.com/im-alexandre/mineru-runpod/commit/75ced01ee83212adcf4c854e4df23a7312facafe))
* update docs stylings ([c512a90](https://github.com/im-alexandre/mineru-runpod/commit/c512a90ecb67d3d2de05b1845f5cfa1269821140))
* update link titles in docs ([2bd7732](https://github.com/im-alexandre/mineru-runpod/commit/2bd7732de30a0358fc8a6ff4d0ddc7bade2e14e8))
* update numbers in blog post ([e742c86](https://github.com/im-alexandre/mineru-runpod/commit/e742c86346a8073deb69fff600c27f14d23ab724))

### Build / Deps

* **deps-dev:** bump semantic-release from 25.0.8 to 25.0.9 in the npm-development group ([#22](https://github.com/im-alexandre/mineru-runpod/issues/22)) ([c331a41](https://github.com/im-alexandre/mineru-runpod/commit/c331a419bc50016a5d4db468e6e22f0a7d440452))
* **deps-dev:** bump the npm-development group with 4 updates ([#6](https://github.com/im-alexandre/mineru-runpod/issues/6)) ([d1b800c](https://github.com/im-alexandre/mineru-runpod/commit/d1b800cc80209732e246f08feb67cb9ea3e5cd7a))
* **deps-dev:** bump the npm-development group with 6 updates ([0f41541](https://github.com/im-alexandre/mineru-runpod/commit/0f415419e5b4f457eaff9a9237d53dde85effd01))
* **deps-dev:** bump the npm-development group with 6 updates ([#15](https://github.com/im-alexandre/mineru-runpod/issues/15)) ([e01fd0b](https://github.com/im-alexandre/mineru-runpod/commit/e01fd0be4663b6e436f485462e52db53a3fa3451))
* **deps:** bump the docs-deps group in /docs with 2 updates ([#23](https://github.com/im-alexandre/mineru-runpod/issues/23)) ([0256269](https://github.com/im-alexandre/mineru-runpod/commit/0256269977b62b36532d8f1c15b0a2f8c363f1dd))
* **deps:** bump the docs-deps group in /docs with 3 updates ([065405a](https://github.com/im-alexandre/mineru-runpod/commit/065405a1a822c2a0965b8963dc377288da3611d6))
* **deps:** bump the docs-deps group in /docs with 4 updates ([#14](https://github.com/im-alexandre/mineru-runpod/issues/14)) ([63880a9](https://github.com/im-alexandre/mineru-runpod/commit/63880a933a4616c45140f10987a70911de797092))
* **deps:** bump the docs-deps group in /docs with 4 updates ([#7](https://github.com/im-alexandre/mineru-runpod/issues/7)) ([79b581e](https://github.com/im-alexandre/mineru-runpod/commit/79b581e4ac98270e286e703e982dddf3bb9d097f))
* **deps:** regenerate docs lockfile for astro 6.4.4; bump sharp to 0.34.5 ([1acdef3](https://github.com/im-alexandre/mineru-runpod/commit/1acdef3940bd1feac22126c7ced4f95c9cbc203b))
* **deps:** restore release notes by pinning the changelog preset ([#20](https://github.com/im-alexandre/mineru-runpod/issues/20)) ([5160306](https://github.com/im-alexandre/mineru-runpod/commit/51603060b01dba6370e34440d672a478c6e676e2))
